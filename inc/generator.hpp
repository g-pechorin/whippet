...
//| License: BSD
//|
//| 2018-01-15; peter.lavalle modified this to allow copying and remove rewind
//|
namespace generator
{
  ...
  struct instance
  {
    ...
    uint32_t _line;
  public:
    instance(void) : _line(0) { }
  };

  // Declaration
  #define $generator(NAME) struct NAME : generator::instance
  ...
  // yields next value(s)
  #define $yield(V)            { _line=__LINE__; _rv = (V); return true; case __LINE__: ; }
  #define $yield2(V1,V2)       { _line=__LINE__; _rv1 = (V1); _rv2 = (V2); return true; case __LINE__: ; }
  #define $yield3(V1,V2,V3)    { _line=__LINE__; _rv1 = (V1); _rv2 = (V2); _rv3 = (V3); return true; case __LINE__: ; }
  #define $yield4(V1,V2,V3,V4) { _line=__LINE__; _rv1 = (V1); _rv2 = (V2); _rv3 = (V3); _rv4 = (V4); return true; case __LINE__: ; }

  // end of value[s] emmiter
	#define $stop  _line=__LINE__; case __LINE__: ; } return false; }
